$(function(){
    $("#reset_mobile_no_step_two_form_id").Validform({
...
function clickSendCode() {
    if ($('#reset_new_mobile_no_id').val() == '' || $('#reset_new_mobile_no_id').val() == null) {
...
function doPostBack() {
    var mobileNo = $("#reset_new_mobile_no_id").val();
    $.ajax({
        type: 'get',
...
//校验手机号是否合法
function isPhoneNum() {
    var phonenum = $("#reset_new_mobile_no_id").val();
