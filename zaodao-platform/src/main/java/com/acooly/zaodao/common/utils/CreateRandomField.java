...
public class CreateRandomField {
	...
	public static final String[] FEMALE_FIRST_NAMES = {
														...
														"Michele", "Gail", "Bertha", "Darlene", "Veronica", "Jill",
														"Erin", "Geraldine", "Lauren",
														
														"Cathy", "Joann", "Lorraine", "Lynn", "Sally", "Regina",
														"Erica", "Beatrice", "Dolores",
...
"Tyler", "Gilbert", "Gene"};
	...
	public final static <T> T nextValue(T[] array) {
		...
		return array[randomno.nextInt(array.length)];
	...
	public final static String getRandomEnglishFirstName() {
		Random randomno = new Random();
		return randomno.nextBoolean() ? nextValue(FEMALE_FIRST_NAMES) : nextValue(MALE_FIRST_NAMES);
