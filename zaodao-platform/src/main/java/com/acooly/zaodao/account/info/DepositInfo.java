...
@AllArgsConstructor
@NoArgsConstructor
public class DepositInfo extends InfoBase{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -2927401240769290861L;
	...
	/**
	 * 冻结金额
	 * <li>在freezeType字段不为空的情况下,本字段有效.
	 * <li>本字段指需要同步冻结的金额,在freezeType不为空的情况下,如本字段不填,则默认冻结本次充值金额.
	 */
